...
class Customer { //class for customer attributes
...
class StockAccount { //class for the stock account
    constructor() {
...
class Createacc extends StockAccount { //class extends from stockAccount to create account
    constructor() {
        super()
    }
...
class BuyStock extends StockAccount { //class for buying a stock
    ...
    buyShare(Name, NoOfShare, userName) {
        try { //function for buying the stock 
            let value;
...
class SellStock extends StockAccount { //class for selling stock
...
class PrintStock extends StockAccount { //class to print the json file
    constructor() {
        super()
    }
